...
import { laserBot } from '../assets/3D'
export default function LaserBot(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(laserBot)
      ...
      <group name='Sketchfab_Scene'>
        <group name='Sketchfab_model' rotation={[-Math.PI / 2, 0, 0]}>
          <group name='Root'>
            <group
              name='Lamp'
              position={[1.651, -1.857, 3.787]}
              rotation={[0.386, 0.539, 0.852]}
            >
              <group name='Lamp_1' />
            </group>
            <group
              name='Cube003'
              position={[0.551, -0.437, 0.77]}
              rotation={[0, 0, 0.887]}
              scale={0.836}
            >
              <mesh
